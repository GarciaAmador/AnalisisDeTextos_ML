Implementación de un autoencoder con sklearn para visualizar los textos de los inciso a) y b) en 2D y 3D. Además, se compara los resultados con Isomap, T-SNE y PCA.
